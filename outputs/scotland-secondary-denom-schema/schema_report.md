...
- `incoming/scotland-secondary-denom/denom_pub_schlsd.shp` — found
- `incoming/scotland-secondary-denom/denom_pub_schlsd.shx` — found
- `incoming/scotland-secondary-denom/denom_pub_schlsd.dbf` — found
- `incoming/scotland-secondary-denom/denom_pub_schlsd.prj` — found
- `incoming/scotland-secondary-denom/denom_pub_schlsd.cpg` — missing
- `incoming/scotland-secondary-denom/denom_pub_schlsd.cst` — found
- `incoming/scotland-secondary-denom/denom_pub_schlsd.xml` — missing
...
- Record count: `63`
- Shape count: `63`
- Bounding box: `BBox(xmin=186173.7109, ymin=530212.2716679329, xmax=363867.2461, ymax=783645.2593998336)`
